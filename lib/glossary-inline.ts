...
export const INLINE_TERM_TO_SLUG: Record<string, string> = {
  ...
  公司指引: "company-guidance",
  guidance: "company-guidance",
  "Earnings Surprise": "earnings-surprise",
  业绩惊喜: "earnings-surprise",
  "Beat / Miss": "earnings-surprise",
  Beat: "earnings-surprise",
  Miss: "earnings-surprise",
  ...
  "bottom-line": "bottom-line",
  底线: "bottom-line",
  "Non-GAAP": "gaap-vs-non-gaap",
  "Adjusted EPS": "gaap-vs-non-gaap",
  调整后每股收益: "gaap-vs-non-gaap",
  "Whisper Number": "whisper-number",
  小道数字: "whisper-number",
};
