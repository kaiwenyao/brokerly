...
IBKR 与 Charles Schwab 为美国版账户；Trading 212、Trade Republic、Robinhood 和 Revolut 为欧洲版账户。本文不讨论开户资格与税务，只计算股票和 ETF 相关交易成本。**美国版账户的产品权限不能套用到爱尔兰账户：EEA 零售客户通常因 PRIIPs KID 限制不能新买 VOO、VTI、SPY、QQQ。** 所有费率核对截至 **2026 年 8 月 8 日**。
...
| 爱尔兰账户定投相同指数 | **Trading 212 / Trade Republic** | 选择 EUR 计价 UCITS ETF；Trading 212 AutoInvest 与 Trade Republic Savings Plan 的合资格买入均可为 €0 |
...
| 定期买 UCITS ETF | **Trading 212 / Trade Republic / Revolut** | T212 AutoInvest 与 Trade Republic Savings Plan 买入免佣；Revolut 的合资格 ETP 计划买入免佣 |

## 全部费用横向比较

| 费用项目 | IBKR US | Schwab US | Trading 212 | Trade Republic | Robinhood EU | Revolut EU |
|---|---|---|---|---|---|---|
| 普通手动订单佣金/结算费 | **Pro Tiered $0.0005–0.0035/股（最低 $0.35）；Pro Fixed $0.005/股（最低 $1、最高成交额 1%）**；另有 Lite 方案为 $0 但依赖订单流付款 | 网上 $0；人工 $25 | $0 | €1 外部结算费；合资格 Savings Plan 买入 €0 | $0（Token） | 每月 1–10 笔免费；合资格 Investment Plan 买入 €0；其他超额订单 0.25% 或 €1 取高 |
...
对爱尔兰普通零售客户，公共产品目录出现美国 ETF 不代表可以下买单。PRIIPs 要求销售前提供 KID，而美国发行人通常不提供符合 EU 要求的文件；应在登录账户后按 ISIN、KID 与订单预览确认，并优先研究 SPYL/VUAA/CSPX、ANAU/CNDX/EQQQ 等 UCITS 版本。

## 最终结论

**纯粹按美国版账户的交易费用看，已有美元时 Schwab 最便宜；但对爱尔兰零售客户，更可执行的路径是用欧元在 Trading 212、Trade Republic 或合资格 Revolut Investment Plan 定投 UCITS ETF。IBKR 的强项在市场覆盖与执行控制，小额定投则会被最低佣金主导。**
