...
| 使用场景 | 费用优势平台 | 核心原因 |
|---|---|---|
| 已持有美元，买卖真实美股 | **Schwab US / IBKR Lite** | 普通网上美股交易佣金 $0；买入不产生卖方监管费 |
...
| 高频买卖且使用美元余额 | **IBKR Lite / Schwab / Trading 212** | 三者合资格交易均可零显性佣金 |
...
|---|---|---|---|---|---|---|
| 美股/ETF 佣金 | Lite $0；Pro Fixed $0.005/股（最低 $1）；Tiered $0.0005–0.0035/股（最低 $0.35） | 网上 $0；人工 $25 | $0 | €1 外部结算费（碎股同） | $0（Token） | 每月 1–10 笔免费；超额 0.25% 或 €1 取高 |
...
| 隐性成本/收入来源 | Lite 订单流付款 | 订单流付款/返佣 | FX + 股票出借 | 价差、第三方费 | 发行人风险 | 超额佣金、付费计划、FX |
...
**纯粹按交易费用看，已有美元时 Schwab US 和 IBKR Lite 最便宜；欧元资金且要求真实美国本土 ETF 时，Trading 212 的"零佣金 + 0.15% 一次性换汇 + 美元余额"组合最均衡。**
